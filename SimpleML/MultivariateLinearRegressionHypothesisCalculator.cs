...
{
    /// <summary>
    /// Calculates the result of the hypothesis function for multi-variate linear regression.
    /// </summary>
    public class MultivariateLinearRegressionHypothesisCalculator : IHypothesisCalculator
    {
        ...
        /// </summary>
        public MultivariateLinearRegressionHypothesisCalculator()
        {
        ...
        public Matrix Calculate(Matrix dataSeries, Matrix thetaParameters)
        {
            ...
            return dataSeries * thetaParameters;
        }
    }
}
